...
import io.rapid.lifecycle.RapidCollectionLiveData;
...
public class LifecycleTestActivity extends LifecycleActivity {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		RapidCollectionLiveData.from(Rapid.getInstance().collection("android_lifecycle_test_001")).observe(this, rapidDocuments -> {
